...
switch method
    case 'average'
        ...
        for rep = 1:average_over_n
            ...
            mri_file = [path_to_MRI_library subject{average_n(rep)} '\MEG\anatomy\T1w_acpc_dc_restore.nii'];
    ...
    case 'best'
        ...
        % Get MRI of winning subject
        mri_file = [path_to_MRI_library subject{winner} '\MEG\anatomy\T1w_acpc_dc_restore.nii'];
