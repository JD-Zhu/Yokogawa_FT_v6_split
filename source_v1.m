function source_v1
    ...
    Beamformer_output_file = 'beamformer_5_TriggerArtefact-removeOnAvgERF.mat'; 
    ...
    for h = 1:7%length(SubjectFolders)
        ...
        elseif strcmp(MEMES_VERSION, 'MEMES3')
            ...
            if ~exist([coreg_output 'headmodel.mat'], 'file')
                ...
                %TODO: wait for Robert reply - what format should bad_coil be?
                bad_coil = ''; 
                if strcmp(SubjectID, 'M08-YL-2763') || strcmp(SubjectID, 'M10-SS-2764')
                    %bad_coil = {white(4), black(5)};
