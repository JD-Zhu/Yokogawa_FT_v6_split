...
S2_output_filename = ['S2_after_visual_rejection' filename_suffix '--removeTriggerLeak_OrigResponseArtefactDef.mat']; % Stage 2 output (stored inside each Subject folder)
